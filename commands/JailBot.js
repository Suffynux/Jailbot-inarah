...
🔒 **!jailbro @user** — Sends a user to Male Jail (removes all roles and gives them the **Jailed-Bro** role)

🔒 **!jailsis @user** — Sends a user to Female Jail (removes all roles and gives them the **Jailed-Sis** role)
